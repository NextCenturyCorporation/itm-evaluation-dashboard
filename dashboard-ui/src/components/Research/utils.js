    ...
    for (const res of completed_surveys) {
        ...
        for (const entry of admOrder) {
            ...
            for (const t of types) {
                ...
                entryObj['Alignment score (Participant_sim|Observed_ADM(target))'] = alignmentComparison;
                if (evalNum == 5)
                    entryObj['Alignment score (Delegator|Observed_ADM (target)) - Phase 1 Server'] = alignmentComparison;
                if (evalNum == 4) {
                    entryObj['Alignment score (Delegator|Observed_ADM (target)) - DRE Server'] = alignmentComparison;
                    ...
                    entryObj['Alignment score (Delegator|Observed_ADM (target)) - Phase 1 Server'] = ph1_comparison_entry?.score ?? '-';
                }
